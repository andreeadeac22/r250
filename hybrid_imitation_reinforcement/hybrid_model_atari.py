...
class Hdqn:
    def __init__(self, gpu):
        ...
        with tf.device('/cpu:'+str(gpu)):
            ...
            controller.add(Dense(HIDDEN_NODES, activation = 'relu', kernel_initializer = initializers.random_normal(stddev=0.01, seed = SEED), input_shape = (2,)))
            ...
            controllerTarget.add(Dense(HIDDEN_NODES, activation = 'relu', kernel_initializer = initializers.random_normal(stddev=0.01, seed = SEED), input_shape = (2,)))
